...
class DataPolisher(object):
    ...
    def loaddata(self, folder):
        ...
        for idx, section in enumerate([ "Business",  "Health",  "Sports", "Tech", "Travel", "World","Arts",]):
            # "Food", "NY","RealEstate", "Science", "Style", "US",, "Politics",
            ...
            #print(idx)
            #print("..................start")
            sectiondata = pd.concat(list_)#,sort = "False")
            sectiondata["label"] = idx
            #print(idx,"..........end")
            # Combine all on class' data variable
            self.data = pd.concat([self.data,sectiondata])#,sort = 'False')
            #print("concat....done......",idx)
