...
def main():
    ...
    CategoriesSections = { "Sports" : ["Sports"]}
    #{"Tech" : ["Technology"], "Travel" : ["Travel"], "Health" : ["Health"],"World" : ["World"],  "Business" : ["Business"],"US" : ["U.S."], "NY" : ["N.Y.", "NY", "New+York"],, "Science" : ["Science"], "Arts" : ["Arts"], "Style" : ["Style"], "Food" : ["Food"], "RealEstate" : ["Real+Estate"]}
    # Initialize class, set pages as well as begindates and enddates
    AllArticles = Articles()
    pages = 100

    # Define begin and end dates
    begin_dates = [20180301, 20170901, 20170301, 20160901, 20160301, 20150901, 20150301, 20140901]#, 20110301, 20100901]
    end_dates = [20180827, 20180228, 20170831, 20170228, 20160831, 20160228, 20150831, 20150229]#, 20110831, 20110228]
