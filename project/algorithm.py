...
class Algorithm(object):
    ...
    def writemodel(self, filename_model, filename_tfidf, filename_stopwords):
        ...
        returns nothing
        """
        with open(PATH_TO_REPO + "data/" + filename_model, 'wb') as f:
            pickle.dump(self.model, f)
        with open(PATH_TO_REPO + "data/" + filename_tfidf, 'wb') as f:
        ...
        with open(PATH_TO_REPO + "data/" + filename_stopwords, 'wb') as f:
